...
public abstract class AbstractJavaCodegen extends DefaultCodegen implements CodegenConfig {
    ...
    protected String artifactDescription = "Rockset Java";
    protected String developerName = "Rockset, Inc";
    protected String developerEmail = "api@rockset.io";
    protected String developerOrganization = "Rockset, Inc";
    protected String developerOrganizationUrl = "https://rockset.com";
    protected String scmConnection = "scm:git:git@github.com:rockset/rockset-java-client.git";
    protected String scmDeveloperConnection = "scm:git:git@github.com:rockset/rockser-java-client.git";
    protected String scmUrl = "https://github.com/rockset/rockset-java-client";
